...
exports.TransitionalFlatList = void 0;
...
var TransitionalFlatList = /** @class */ (function (_super) {
    __extends(TransitionalFlatList, _super);
    function TransitionalFlatList(props) {
        var _this = _super.call(this, props) || this;
        _this.anim = new react_native_1.Animated.Value(1);
        _this.styleHolder = {
            ListFooterComponentStyle: interpolator_1.createStyleHolder(),
            ListHeaderComponentStyle: interpolator_1.createStyleHolder(),
            columnWrapperStyle: interpolator_1.createStyleHolder(),
    ...
    TransitionalFlatList.prototype.componentDidUpdate = function () {
    ...
    TransitionalFlatList.prototype.render = function () {
...
exports.TransitionalFlatList = TransitionalFlatList;
exports.default = TransitionalFlatList;
